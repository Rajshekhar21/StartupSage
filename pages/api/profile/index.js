...
import { findProfileByUserId, insertProfile, updateProfileByUserId } from '@/api-lib/db/profile';
...
handler.put(async (req, res) => {
    ...
    if (!req.user.profileCreated) {
        res.status(400).json({ error: { message: 'This user has not created a profile' } })
        return
    }
