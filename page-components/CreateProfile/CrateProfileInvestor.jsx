...
export default function CreateProfileInvestor({ isEditMode, toggleEditMode }) {
        ...
        <form onSubmit={onSubmit}>
          <div className="space-y-12">
            <div className=" border-gray-900/10 pb-12">
              ...
              >
                {isEditMode ? 'Edit Profile' : 'Investor Onboarding Form'}
              </h1>
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div className="col-span-3">
                  ...
                  >
                    Which kind of startup you are investing in?
                  </label>
                  <div className="mt-2">
                    <textarea
                      required
